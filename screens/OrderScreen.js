...
export default function OrderScreen({ userData }) {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      axios
        .get(`http://172.20.10.4:5000/pesanans2`, {
          params: {
            user_id: userId,
      ...
      axios
        .get("http://172.20.10.4:5000/menus")
        .then((response) => {
      ...
      axios
        .get(`http://172.20.10.4:5000/review/${userId}`)
        .then((response) => {
                                ...
                                Alert.alert(
                                  ...
                                  [
                                    { text: "Cancel" },
                                    {
                                      ...
                                      onPress: () => {
                                        const id = review.id;
                                        fetch(`http://172.20.10.4:5000/reviews/delete/${id}`, {
                                          method: "DELETE",
                                        })
